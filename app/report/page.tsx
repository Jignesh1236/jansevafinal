        ...
        <div className="bg-white rounded-xl shadow-lg p-6 text-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-green-50 p-4 rounded-lg">
              ...
              <p className="text-2xl font-bold text-green-700">₹{(incomeTotal + depositTotal + stampTotal + balanceTotal + mgvclTotal + onlinePaymentTotal).toFixed(2)}</p>
            </div>
          ...
          <button
            ...
            disabled={loading || (!canSubmitToday && !adminPermissionRequested)}
          >
