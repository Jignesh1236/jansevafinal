  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {!isAuthenticated ? (
          <div className="bg-white p-8 rounded-2xl shadow-xl space-y-6 max-w-md mx-auto backdrop-blur-sm bg-opacity-95">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">Please enter your credentials to access the tools dashboard</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <button
                onClick={handleLogin}
                className="w-full bg-gradient-to-r from-primary to-secondary text-white py-3 px-6 rounded-lg hover:from-secondary hover:to-primary transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
